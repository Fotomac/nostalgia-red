Route8Object:
	...
	object SPRITE_BRUNETTE_GIRL, $1a, $3, STAY, LEFT, $4, OPP_LASS, $c
	object SPRITE_BLACK_HAIR_BOY_2, $1a, $4, STAY, RIGHT, $5, OPP_SUPER_NERD, $5
	object SPRITE_BRUNETTE_GIRL, $1a, $5, STAY, LEFT, $6, OPP_LASS, $d
	object SPRITE_BRUNETTE_GIRL, $1a, $6, STAY, RIGHT, $7, OPP_LASS, $e
	object SPRITE_GAMBLER, $2e, $d, STAY, DOWN, $8, OPP_GAMBLER, $7
	object SPRITE_BRUNETTE_GIRL, $33, $c, STAY, LEFT, $9, OPP_LASS, $f
