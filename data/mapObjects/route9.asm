Route9Object:
	...
	db $a ; objects
	object SPRITE_BRUNETTE_GIRL, $d, $a, STAY, LEFT, $1, OPP_JR_TRAINER_F, $5
	...
	object SPRITE_BRUNETTE_GIRL, $30, $8, STAY, RIGHT, $4, OPP_JR_TRAINER_F, $6
	object SPRITE_HIKER, $10, $f, STAY, LEFT, $5, OPP_HIKER, $f
