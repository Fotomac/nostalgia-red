CeladonGymObject:
	...
	object SPRITE_BRUNETTE_GIRL, $2, $b, STAY, RIGHT, $2, OPP_LASS, $10
	object SPRITE_FOULARD_WOMAN, $7, $a, STAY, LEFT, $3, OPP_BEAUTY, $1
	object SPRITE_BRUNETTE_GIRL, $9, $5, STAY, DOWN, $4, OPP_JR_TRAINER_F, $b
	object SPRITE_FOULARD_WOMAN, $1, $5, STAY, DOWN, $5, OPP_BEAUTY, $2
	object SPRITE_BRUNETTE_GIRL, $6, $3, STAY, DOWN, $6, OPP_LASS, $11
