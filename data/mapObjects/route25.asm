Route25Object:
	...
	object SPRITE_BLACK_HAIR_BOY_1, $18, $4, STAY, DOWN, $3, OPP_JR_TRAINER_M, $a
	object SPRITE_BRUNETTE_GIRL, $12, $8, STAY, RIGHT, $4, OPP_JR_TRAINER_F, $19
	object SPRITE_BUG_CATCHER, $20, $3, STAY, LEFT, $5, OPP_YOUNGSTER, $7
	object SPRITE_BRUNETTE_GIRL, $25, $4, STAY, DOWN, $6, OPP_LASS, $9
