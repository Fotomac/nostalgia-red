Route13Object:
	...
	object SPRITE_BRUNETTE_GIRL, $30, $a, STAY, DOWN, $2, OPP_JR_TRAINER_F, $c
	object SPRITE_BRUNETTE_GIRL, $1b, $9, STAY, DOWN, $3, OPP_JR_TRAINER_F, $d
	object SPRITE_BRUNETTE_GIRL, $17, $a, STAY, LEFT, $4, OPP_JR_TRAINER_F, $e
	object SPRITE_BRUNETTE_GIRL, $32, $5, STAY, DOWN, $5, OPP_JR_TRAINER_F, $f
