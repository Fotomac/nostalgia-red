MapSongBanks:
	...
	db MUSIC_VERMILION, 0 ; UndergroundTunnelEntranceRoute6
	db MUSIC_VERMILION, 0 ; FREEZE
	db MUSIC_CITIES1, 0 ; Route7Gate
	db MUSIC_CELADON, 0 ; UndergroundPathEntranceRoute7
	...
	db MUSIC_CITIES2, 0 ; KogasHouseEntrance
	db MUSIC_DUNGEON2, 0 ; KogasHouse
	db MUSIC_DUNGEON1, 0
